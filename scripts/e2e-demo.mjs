...
const btn = { History: /HIST/, Intervals: /Intervals/, Algebra: /Algebra/, Accounting: /ACCT/, Chemistry: /CHEM/, Economics: /ECON/ }[demo];
...
const answers = { History: ["I know the events, not how they connect", "Why does that matter?", "idk", "Germany declares war on Russia because it backs Austria", "Britain declares war and its empire joins", "Yes, let's go", "Nationalism mattered because Serbian nationalists wanted independence, so one shot the Archduke."],
  Intervals: ["I don't know what ∩ and ∪ mean", "0 to 1", "from 0 to 2", "Why do we draw it?", "(-3, 3]", "Yes, let's go", "(3, 5)"],
