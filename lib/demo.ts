    ...
    script: [
      ...
      t({
        ...
        board: [
          ...
          { type: "narrate", text: "On the left, plus 7 minus 7 cancels, so only 3x is left. But look at the 22 on the right: it still needs 7 taken away." },
      ...
      t({
        ...
        board: [
          ...
          { type: "narrate", text: "It comes out to 22, exactly what the original equation promised, so the answer works." },
          { type: "pointTo", target: "eq1", match: "22", text: "matches!" },
          { type: "narrate", text: "That check is your safety net on every test." },
  ...
  lesson: {
    ...
    script: [
      ...
      t({
        ...
        board: [
          { type: "narrate", text: "Here's the adjusting entry, written as a journal entry." },
          { type: "clear" },
          { type: "table", id: "je", zone: "full", headers: ["Date", "Account", "Debit", "Credit"], rows: [["Dec 31", "Insurance Expense", "3,000", ""], ["", "   Prepaid Insurance", "", "3,000"]] },
          { type: "narrate", text: "We debit Insurance Expense 3,000, because the used-up part is now a cost of doing business." },
          { type: "pointTo", target: "je.1.2", match: "", text: "debit: expense ↑" },
          { type: "narrate", text: "And we credit Prepaid Insurance 3,000, because that much of the asset is gone. Cash doesn't move at all: it left back in October." },
          { type: "pointTo", target: "je.2.3", match: "", text: "credit: asset ↓" },
  ...
  lesson: {
    ...
    script: [
      ...
      t({
        ...
        board: [
          { type: "narrate", text: "See where the two lines cross? That's the one spot where buyers and sellers agree on both the price and the quantity." },
          { type: "pointTo", target: "g1", match: "8,6", text: "they agree here" },
          { type: "narrate", text: "At that spot both equations give the same P, so I set their right-hand sides equal." },
